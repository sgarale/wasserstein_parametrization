...
if __name__ == '__main__':
    ...
    # reference measure at a specific uncertainty level (uncertainty_level)
    ...
    if eval_type in ['both', 'one_dimensional']:
        ...
        dump_summary.write(f'\nWorst case loss via asymptotic optimizer: {ws_loss_1d[ws_loss_1d.shape[0]-1]:.8f}')
    ...
    if eval_type in ['both', 'neural_network']:
        ...
        dump_summary.write(f'\nWorst case loss via neural network optimizer: {out_vector[out_vector.shape[0]-1]:.8f}')
